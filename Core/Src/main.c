...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, SYSTEM_LED_Pin|LCDRESET_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(TRIGGER_OUT_GPIO_Port, TRIGGER_OUT_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, TOUCH_CS_Pin|FLASH_SS_Pin|LCDCS_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : TOUCH_CS_Pin LCDRESET_Pin LCDCS_Pin */
  GPIO_InitStruct.Pin = TOUCH_CS_Pin|LCDRESET_Pin|LCDCS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  ...
  /*Configure GPIO pins : LD8_Pin LD7_Pin */
